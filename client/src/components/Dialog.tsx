        ...
        <div className='flex flex-col items-center justify-center '>
          ...
          <div className='flex flex-col gap-4 font-light'>
            ...
            <p>
              ...
              <span className='italic text-sm'>(capitals coming soon...).</span>{' '}
            ...
            <p>
              ...
              <span className='text-indigo-500 font-semibold'>...10 secs</span>
            </p>
            <p>
              The main crux is the{' '}
              <span className='text-indigo-600'>Multi Player</span> mode. <br />
              Create a game, A roomID is generated for that game. Join the game
              using that roomID and send the roomID to the other player to join.{' '}
              <br /> <br />
              <span className='text-indigo-600 italic text-sm font-semibold'>
                Note: to avoid the creation of unused rooms, you can't create a
                room and join another room. so, if you are creating,{' '}
            ...
            <p>
              Notice any bug or have a relevant addition to this project message
              me on{' '}
              <a
          ...
          <button
            className='px-4 py-2 text-lg text-red-700 rounded hover:opacity-75 mt-4'
            onClick={closeModal}>
            Close
          </button>
        </div>
